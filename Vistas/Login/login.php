...
// Definir BASE_URL si no está definida (ajusta según tu proyecto)
if (!defined('BASE_URL')) {
    define('BASE_URL', '/'); // Cambia por la ruta base de tu aplicación
}

// Capturar mensajes desde controlador o URL
...
<head>
    ...
    <title>Unio | Conéctate a través de Eventos Reales</title>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet">
    <!-- Bootstrap CSS (para el header) -->
...
<body class="bg-background text-on-surface selection:bg-primary-container/30">
    ...
    <nav class="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-md shadow-[0_8px_32px_rgba(45,47,47,0.06)] h-16">
        <div class="flex justify-between items-center px-8 h-full w-full max-w-screen-2xl mx-auto">
            ...
            <div class="flex items-center gap-4">
                <a href="<?php echo BASE_URL; ?>?c=registro" class="hidden md:block bg-primary text-on-primary px-6 py-2 rounded-full font-bold text-sm transition-transform active:scale-95 shadow-sm">
                    Registrate
                </a>
            </div>
        </div>
    ...
    <main class="kinetic-prism-bg">
        <!-- Hero Section (sin el padding-top que usaba el nav fijo) -->
            ...
            <div class="grid lg:grid-cols-12 gap-16 items-center w-full">
                ...
                <div class="lg:col-span-7 space-y-8">
                    ...
                    <h1 class="text-[3.5rem] md:text-[4.5rem] font-extrabold leading-[1.05] tracking-tighter text-on-surface font-headline">
                        ...
                        <span class="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent italic">Eventos Reales</span>
                    </h1>
                ...
                <!-- Login Form Card (con lógica PHP) -->
                    ...
                    <div class="bg-surface-container-lowest p-8 md:p-10 rounded-[2rem] shadow-[0_32px_64px_-16px_rgba(45,47,47,0.08)] relative overflow-hidden">
                        ...
                        <div class="relative space-y-6">
                            ...
                            <?php if ($registro_exitoso): ?>
                                <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded-md flex items-start gap-2 text-sm">
                            ...
                            <?php endif; ?>
                            <?php if (!empty($error)): ?>
                                <div class="bg-error-container/20 border-l-4 border-error text-on-error-container p-4 rounded-md flex items-start gap-2 text-sm">
                            ...
                            <!-- Formulario de login -->
                            <form action="<?php echo BASE_URL; ?>?c=login&a=login" method="POST">
                                <div class="space-y-4">
                                    <div class="space-y-1.5">
                                        <label for="correo" class="text-[0.75rem] font-bold text-on-surface-variant uppercase tracking-wider ml-1">Correo Electrónico</label>
                                        <input type="email" id="correo" name="correo" class="w-full px-5 py-4 rounded-xl bg-surface-container-low border-none focus:ring-2 focus:ring-primary/20 placeholder:text-outline-variant transition-all" placeholder="alex@ejemplo.com" required>
                                    </div>
                                    <div class="space-y-1.5">
                                        <label for="password" class="text-[0.75rem] font-bold text-on-surface-variant uppercase tracking-wider ml-1">Contraseña</label>
                                        <input type="password" id="password" name="password" class="w-full px-5 py-4 rounded-xl bg-surface-container-low border-none focus:ring-2 focus:ring-primary/20 placeholder:text-outline-variant transition-all" placeholder="••••••••" required>
                                    </div>
                                </div>
                                <button type="submit" class="w-full mt-6 py-4 bg-gradient-to-br from-primary to-primary-container text-white rounded-xl font-bold text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:translate-y-[-2px] active:translate-y-[0] transition-all duration-300">
                                    Iniciar Sesión
                                </button>
                            </form>

                            <div class="text-center mt-4">
                                <a class="text-sm text-primary hover:underline font-medium italic" href="#">¿Olvidaste tu contraseña?</a>
                            </div>
                            <div class="pt-4 text-center border-t border-surface-container-high">
                                <p class="text-sm text-on-surface-variant">¿No tienes una cuenta? <a href="<?php echo BASE_URL; ?>?c=registro" class="text-primary font-bold hover:underline">Registrarse</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Bento Grid Features Section (sin cambios) -->
        <section class="px-8 lg:px-24 py-24 max-w-screen-2xl mx-auto">
            <div class="text-center mb-16 space-y-4">
                <h2 class="text-4xl md:text-5xl font-black tracking-tight text-on-surface">Explora nuevas dimensiones</h2>
                <p class="text-lg text-on-surface-variant max-w-2xl mx-auto">Diseñamos Unio para que la tecnología facilite el contacto humano real, no para reemplazarlo.</p>
            </div>
            <div class="grid md:grid-cols-12 gap-6 h-auto">
                <!-- Feature: Hyper-Local Discovery -->
                <div class="md:col-span-8 bg-surface-container-lowest rounded-[2.5rem] p-10 flex flex-col justify-between group overflow-hidden relative shadow-sm hover:shadow-md transition-shadow">
                    <div class="absolute top-0 right-0 p-8">
                        <span class="material-symbols-outlined text-primary text-5xl opacity-20 group-hover:opacity-100 transition-opacity duration-500" style="font-variation-settings: 'FILL' 1;">location_on</span>
                    </div>
                    <div class="relative z-10 space-y-4 max-w-md">
                        <div class="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
                            <span class="material-symbols-outlined">explore</span>
                        </div>
                        <h3 class="text-3xl font-bold">Descubrimiento Hiper-Local</h3>
                ...
                <div class="md:col-span-4 bg-primary rounded-[2.5rem] p-10 flex flex-col justify-between text-on-primary group shadow-lg shadow-primary/20">
                    ...
                    <div class="mt-auto pt-8 flex items-center justify-center">
                        <div class="relative w-32 h-32">
                            ...
                            <span class="material-symbols-outlined absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-4xl">share_reviews</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="md:col-span-12 bg-surface-container-high rounded-[2.5rem] overflow-hidden relative group min-h-[400px]">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-12 md:p-20 flex flex-col justify-end">
                        <h4 class="text-white text-4xl md:text-5xl font-black tracking-tight mb-4">Vive la experiencia Unio</h4>
                        <p class="text-white/80 text-lg md:text-xl max-w-2xl">Explora miles de eventos cada fin de semana en tu ciudad y redescubre lo que significa estar presente.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24 px-8 max-w-screen-xl mx-auto text-center">
            <div class="bg-gradient-to-br from-primary to-primary-dim p-12 md:p-20 rounded-[3rem] text-on-primary space-y-8 relative overflow-hidden shadow-2xl shadow-primary/30">
                ...
                <h2 class="text-4xl md:text-6xl font-black tracking-tight relative z-10">¿Listo para salir de la pantalla?</h2>
                <p class="text-xl text-on-primary/80 max-w-2xl mx-auto relative z-10 font-medium">Únete a la comunidad de personas que están redefiniendo cómo nos conectamos en el mundo físico.</p>
                <div class="flex flex-col sm:flex-row justify-center relative z-10">
                    <a href="<?php echo BASE_URL; ?>?c=registro" class="bg-white text-primary px-10 py-5 rounded-2xl font-extrabold text-lg flex items-center justify-center gap-2 shadow-xl hover:bg-slate-50 transition-colors">
        ...
        <div class="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="space-y-6">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-black tracking-tighter text-[#5a2af7]">Unio</span>
                </div>
            ...
            <div class="space-y-4">
                <h5 class="font-bold text-sm uppercase tracking-widest text-on-surface">Producto</h5>
            ...
            <div class="space-y-4">
                <h5 class="font-bold text-sm uppercase tracking-widest text-on-surface">Comunidad</h5>
                <ul class="space-y-2 text-on-surface-variant text-sm">
            ...
            <div class="space-y-4">
                <h5 class="font-bold text-sm uppercase tracking-widest text-on-surface">Legal</h5>
                <ul class="space-y-2 text-on-surface-variant text-sm">
    ...
    <!-- Bootstrap JS (necesario para el funcionamiento del menú colapsable) -->
